...
public class TestNotRequestSubscriber extends AbstractSubscriber {

    private static final Logger LOG = notNull (LoggerFactory.getLogger (TestNotRequestSubscriber.class));
    ...
    public TestNotRequestSubscriber () {
