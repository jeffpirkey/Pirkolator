...
public interface IDaoChannel<T, ID extends Serializable> extends IDataAccess<T, T, ID> {
    ...
    @Override
    Iterable<? extends T> findAll (Iterable<ID> ids);
    ...
    @Override
    Iterable<? extends T> findAll (Sort sort);
     ...
     */
    @Override
    Page<? extends T> findAll (Pageable pageable);
}
